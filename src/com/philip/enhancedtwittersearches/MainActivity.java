package com.philip.enhancedtwittersearches;
			...
			builder.setItems(R.array.filter_items,
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							// Search URL + filter
							String filteredImageSearch = searchTag
									+ "+filter:images";
							String filteredVideoSearch = searchTag
									+ "+filter:videos";
							String filteredLinksSearch = searchTag
									+ "+filter:links";
							...
							case 0: // images filter option
								urlString = getString(R.string.searchURL)
										+ Uri.encode(filteredImageSearch,
												"UTF-8");
							...
							case 1: // videos filter option
								urlString = getString(R.string.searchURL)
										+ Uri.encode(filteredVideoSearch,
												"UTF-8");
							...
							case 2: // links filter option
								urlString = getString(R.string.searchURL)
										+ Uri.encode(filteredLinksSearch,
												"UTF-8");
